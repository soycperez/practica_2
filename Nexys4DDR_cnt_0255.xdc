...
set_property -dict { PACKAGE_PIN H17   IOSTANDARD LVCMOS33 } [get_ports { Sec_det }]; #IO_L18P_T2_A24_15 Sch=led[0]
...
set_property -dict { PACKAGE_PIN P17   IOSTANDARD LVCMOS33 } [get_ports { Ent_s }]; #IO_L9P_T1_DQS_14 Sch=btnc
...
#set_property CLOCK_DEDICATED_ROUTE FALSE [get_nets dig]
#set_property CLOCK_DEDICATED_ROUTE FALSE [get_nets dis]